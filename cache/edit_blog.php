...
<div class="col-5 container border rounded bg-light">
    <form class="col-11" action="editblog" method="post" id="form1" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input value="<?php echo $blog['name'] ?>" type="name" class="form-control" id="blogname" name="blogname" placeholder="Insert blog name..." required>
        </div>
        <div class="form-group">
            ...
            <select class="form-control" id="blogargument" name="blogargument" disabled>
                ...
                <option value="<?php echo $argument['id'] ?>" <?php if($blog['id_argument']==$argument['id']): ?>selected<?php endif ?>>
                    <?php echo $argument["parent_argument_name"]?ucfirst($argument["parent_argument_name"])." -> ":"" ?> <?php echo ucfirst($argument["name"]) ?>
                </option>
                <?php endforeach ?>
            </select>
        </div>
        <div class="form-group">
            ...
            <select class="form-control" id="blogtheme" name="blogtheme">
                ...
                <option value="<?php echo $theme['id'] ?>" <?php if($blog['id_theme']==$theme['id']): ?>selected<?php endif ?>>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="blogcoauthor" name="blogcoauthor">
                ...
                <option value="<?php echo $author['id'] ?>" <?php if($blog['id_coauthor']==$author['id']): ?>selected<?php endif ?>>
        ...
        <div>
            ...
            <img style="width: 540px; height: 336px;border: 1px solid #DDD;" src="public/static/contents/blog_images/<?php echo $blog['path_copertina'] ?: 'default.png' ?>" alt="#"/>
